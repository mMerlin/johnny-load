...
var five, fullModel, BASE_PROPERTIES, crumbs, addSubModel, buildComponent,
 ...
 * @return {object}
 */
function loadComponentsForModel(model) {
...
buildComponent = function (container, config, key) {
  ...
  // }
  container[key] = new five[config.class](config.options);
